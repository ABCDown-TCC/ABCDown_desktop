...
function SearchInput(props: SearchInputProps) {
    return (
        ...
        >
            <input style={{ marginLeft: '5%', border: 'none', outline: 'none', backgroundColor: '#E6E6E6', height: '100%', width: '100%' }}
...
function MinhasAtividades() {
    ...
    return (
        <>
            <div style={{ display: 'flex', flexWrap: 'wrap', width: '80%', height: '100%', background: 'red' ,justifyContent:'flex-end',gap:'40px'}}>
                <div style={{ width: '17vw', height: '25vh', borderRadius: '20px', backgroundColor: 'white' }}></div>
                <div style={{ width: '17vw', height: '25vh', borderRadius: '20px', backgroundColor: 'white' }}></div>
                <div style={{ width: '17vw', height: '25vh', borderRadius: '20px', backgroundColor: 'white' }}></div>
                <div style={{ width: '17vw', height: '25vh', borderRadius: '20px', backgroundColor: 'white' }}></div>
                <div style={{ width: '17vw', height: '25vh', borderRadius: '20px', backgroundColor: 'white' }}></div>
        ...
        <>
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ width: '100%', height: '50%', borderBottom: '3px solid #e6e6e6' }}>
                        <div style={{
                            width: '30%', height: '100%',
                ...
                <div style={{ width: '100%', height: '85%', backgroundColor: 'blue' }}>
                    <div style={{ width: '100%', backgroundColor: '#F2F2F2', maxHeight: '100%', overflowY: 'auto' }}>
